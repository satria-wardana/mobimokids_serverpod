...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['test'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'getTestJson': _i1.MethodConnector(
          name: 'getTestJson',
          params: {
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['test'] as _i3.TestEndpoint).getTestJson(
            session,
            params['author'],
            params['text'],
          ),
        ),
        'postTestJson': _i1.MethodConnector(
          name: 'postTestJson',
          params: {
            'author': _i1.ParameterDescription(
              name: 'author',
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['test'] as _i3.TestEndpoint).postTestJson(
            session,
            params['author'],
            params['text'],
          ),

...
import 'package:emo_project_server/src/generated/endpoints.dart';
...
class _TestEndpoint {
  ...
  _i3.Future<String> postTestJson(
    _i1.TestSessionBuilder sessionBuilder,
    String author,
    String text,
  ) async {
